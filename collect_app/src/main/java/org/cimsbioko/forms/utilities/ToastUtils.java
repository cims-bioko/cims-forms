...
public class ToastUtils {
    ...
    private static void showToast(String message, int duration) {
        Toast.makeText(FormsApp.getInstance(), message, duration).show();
    }

    private static void showToast(int messageResource, int duration) {
        Toast.makeText(FormsApp.getInstance(), FormsApp.getInstance().getString(messageResource), duration).show();
    }

    public static void showShortToastInMiddle(int messageResource) {
        showToastInMiddle(FormsApp.getInstance().getString(messageResource), Toast.LENGTH_SHORT);
    }
    ...
    public static void showLongToastInMiddle(int messageResource) {
        showToastInMiddle(FormsApp.getInstance().getString(messageResource), Toast.LENGTH_LONG);
    }

    private static void showToastInMiddle(String message, int duration) {
        Toast toast = Toast.makeText(FormsApp.getInstance(), message, duration);
