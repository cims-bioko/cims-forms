...
import org.cimsbioko.forms.logic.FormController.InstanceMetadata;
...
public class EncryptionUtils {
    ...
    public static EncryptedFormInformation getEncryptedFormInformation(Uri uri,
        ...
        ContentResolver cr = FormsApp.getInstance().getContentResolver();
        ...
        try {
            if (InstanceColumns.CONTENT_ITEM_TYPE.equals(cr.getType(uri))) {
                ...
                try {
                    ...
                    if (instanceCursor.getCount() != 1) {
                        String msg = FormsApp.getInstance().getString(R.string.not_exactly_one_record_for_this_instance);
                        Timber.e(msg);
                ...
                if (formCursor.getCount() != 1) {
                    String msg = FormsApp.getInstance().getString(R.string.not_exactly_one_blank_form_for_this_form_id);
                    Timber.e(msg);
                    throw new EncryptionException(msg, null);
                }
            ...
            if (formId == null || formId.length() == 0) {
                String msg = FormsApp.getInstance().getString(R.string.no_form_id_specified);
                Timber.e(msg);
                throw new EncryptionException(msg, null);
            }
            ...
            try {
                ...
                String msg = FormsApp.getInstance().getString(R.string.phone_does_not_support_rsa);
            ...
            try {
                ...
                String msg = FormsApp.getInstance().getString(R.string.invalid_rsa_public_key);
                Timber.e(e, "%s due to %s ", msg, e.getMessage());
                throw new EncryptionException(msg, e);
            }
        } finally {
