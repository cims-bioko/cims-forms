...
public class QRCodeUtils {
    public static final String QR_CODE_FILEPATH = FormsApp.getFileSystem().getSettings() + File.separator + "collect-settings.png";
    ...
    static final String MD5_CACHE_PATH = FormsApp.getFileSystem().getSettings() + File.separator + SETTINGS_MD5_FILE;
    ...
    public static Bitmap generateQRBitMap(String data, int sideLength) throws IOException, WriterException {
        ...
        if (compressedData.length() > 4000) {
            throw new IOException(FormsApp.getInstance().getString(R.string.encoding_max_limit));
        }
