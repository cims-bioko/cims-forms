...
import org.cimsbioko.forms.widgets.interfaces.ButtonWidget;
import org.cimsbioko.forms.widgets.interfaces.MultiChoiceWidget;
import org.cimsbioko.forms.widgets.warnings.SpacesInUnderlyingValuesWarning;
...
public class SpinnerMultiWidget extends ItemsWidget implements ButtonWidget, MultiChoiceWidget {
    ...
    public SpinnerMultiWidget(final Context context, FormEntryPrompt prompt) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            styledAnswerItems[i] = org.cimsbioko.forms.utilities.TextUtils.textToHtml(answerItems[i]);
        }
    ...
    private void showSelectedValues(List<String> selectedValues) {
        if (selectedValues.isEmpty()) {
            ...
            CharSequence answerText = org.cimsbioko.forms.utilities.TextUtils.textToHtml(String.format(getContext().getString(R.string.selected_answer),
