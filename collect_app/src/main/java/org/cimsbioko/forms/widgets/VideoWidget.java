...
public class VideoWidget extends QuestionWidget implements FileWidget {
     ...
     * @see org.cimsbioko.forms.activities.FormEntryActivity#onActivityResult(int, int, Intent)
     */
    @Override
