...
import static org.cimsbioko.forms.preferences.AdminKeys.ALLOW_OTHER_WAYS_OF_EDITING_FORM;
import static org.cimsbioko.forms.preferences.GeneralKeys.KEY_AUTOMATIC_UPDATE;
import static org.cimsbioko.forms.preferences.GeneralKeys.KEY_AUTOSEND;
import static org.cimsbioko.forms.preferences.GeneralKeys.KEY_CONSTRAINT_BEHAVIOR;
import static org.cimsbioko.forms.preferences.GeneralKeys.KEY_GUIDANCE_HINT;
import static org.cimsbioko.forms.preferences.GeneralKeys.KEY_IMAGE_SIZE;
import static org.cimsbioko.forms.preferences.GeneralKeys.KEY_PERIODIC_FORM_UPDATES_CHECK;
        ...
        if (pref != null) {
            ...
            pref.setOnPreferenceChangeListener((preference, newValue) -> {
                ...
                if (key.equals(KEY_PERIODIC_FORM_UPDATES_CHECK)) {
                    ...
                    FormsApp.getInstance().logRemoteAnalytics("PreferenceChange", "Periodic form updates check", (String) newValue);
    ...
    private void initPref(String key) {
        ...
        if (pref != null) {
            if (key.equals(KEY_AUTOMATIC_UPDATE)) {
                ...
                pref.setOnPreferenceChangeListener((preference, newValue) -> {
                    FormsApp.getInstance().logRemoteAnalytics("PreferenceChange", "Automatic form updates", newValue + " " + formUpdateCheckPeriod);
