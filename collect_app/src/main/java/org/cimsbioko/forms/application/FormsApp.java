...
import org.cimsbioko.forms.jobs.CollectJobCreator;
...
import org.cimsbioko.forms.preferences.AutoSendPreferenceMigrator;
import org.cimsbioko.forms.preferences.FormMetadataMigrator;
...
public class FormsApp extends Application {
     ...
     * and application version name: {@code Dalvik/<version> (platform info) org.cimsbioko.forms/v<version>}.
     *
    ...
    */
    ...
    public String getCurrentCampaign() {
        try (Cursor c = getContentResolver().query(CURRENT_CAMPAIGN_URL, null, null, null, null)) {
            if (c != null && c.moveToFirst()) {
                return c.getString(0);
            }
            return null;
