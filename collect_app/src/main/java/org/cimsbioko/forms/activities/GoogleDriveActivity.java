...
import org.cimsbioko.forms.listeners.TaskListener;
import org.cimsbioko.forms.logic.DriveListItem;
...
import static org.cimsbioko.forms.utilities.gdrive.GoogleAccountsManager.showSettingsDialog;
...
public class GoogleDriveActivity extends FormListActivity implements View.OnClickListener,
    ...
    private class GetFileTask extends
            ...
            for (int k = 0; k < fileItems.size(); k++) {
                ...
                try {
                    ...
                    if (folderId != null) {
                        ...
                        FileUtils.createFolder(FormsApp.getFileSystem().getFormsPath() + File.separator + mediaDirName);
        ...
        private void downloadFile(@NonNull String fileId, String fileName) throws IOException {
            File file = new File(FormsApp.getFileSystem().getFormsPath() + File.separator + fileName);
