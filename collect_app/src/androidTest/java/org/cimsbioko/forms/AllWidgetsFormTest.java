...
import static org.cimsbioko.forms.test.CustomMatchers.withProgress;
import static org.cimsbioko.forms.test.FormLoadingUtils.ALL_WIDGETS_FORM;
...
public class AllWidgetsFormTest {
    ...
    public void skipInitialLabel() {
        ...
        onView(withText(startsWith("Welcome to CIMS Forms!"))).perform(swipeLeft());
