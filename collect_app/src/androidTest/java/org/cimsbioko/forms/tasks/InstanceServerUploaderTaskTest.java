...
import static org.cimsbioko.forms.test.TestUtils.cleanUpTempFiles;
import static org.cimsbioko.forms.test.TestUtils.createTempFile;
import static org.cimsbioko.forms.test.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTaskTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("Dalvik/.* org.cimsbioko.forms/.*", r.getHeader("User-Agent"));
